...
SRC=ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
	...
	ft_strnstr.c ft_strcmp.c ft_strncmp.c ft_atoi.c ft_isdigit.c \
	ft_iswhitespace.c ft_isalpha.c ft_isalnum.c ft_isascii.c ft_isprint.c \
	ft_toupper.c ft_tolower.c ft_putchar.c ft_putstr.c ft_memalloc.c \
	...
	ft_lststrsplit.c ft_lststrtoarr.c ft_lstsize.c get_next_line.c \
	ft_putnstr.c ft_putnendl.c ft_atoi_n.c
...
OBJ=ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o \
	...
	ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o ft_isdigit.o \
	ft_iswhitespace.o ft_isalpha.o ft_isalnum.o ft_isascii.o ft_isprint.o \
	ft_toupper.o ft_tolower.o ft_putchar.o ft_putstr.o ft_memalloc.o \
	...
	ft_lststrsplit.o ft_lststrtoarr.o ft_lstsize.o get_next_line.o \
	ft_putnstr.o ft_putnendl.o ft_atoi_n.o
